    ...
    <Layout>
      <section className="aboutUs bg-black min-h-lvh w-full text-white flex flex-col justify-center items-center xl:pt-20 xl:px-36 px-4 pt-16 overflow-hidden">
        ...
        <div className="flex flex-col justify-center h-full w-full items-center mx-10 aboutUs aboutUs__container lg:px-10 pb-40 max-[600px]:px-8 max-[550px]:px-4 max-[480px]:px-0 lg:mb-20 min-[1800px]:mb-60">
          ...
          {text === 'Version' && (
            <div className=" font-secondary font-light text-justify xl:text-xs text-[0.75rem] lg:mt-1 min-[2000px]:mt-10 min-[340px]:text-base min-[601px]:max-[1000px]:text-[.6rem] min-[601px]:max-[1000px]:leading-[1.5]  min-[601px]:px-10 flex flex-col justify-between gap-3 max-[639px]:gap-2 min-[2400px]:mx-64 min-[2100px]:mx-40 2xl:text-base max-[600px]:mx-2 mt-2 sm:mt-0 min-[601px]:mt-0 sm:px-10 aboutUs__para">
              {' '}
